...
class __TwigTemplate_209cc01b945dcd924629f10e3a3a4f7c5b54b332edf35ad4918fc8e0ff008d47 extends \Twig\Template
{
...
($context["cron_status"] ?? null) == 2)) {
            ...
            echo $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SCHEDULER_CRON_NA", [0 => ($context["user"] ?? null)]);
            echo "</div>
    ";
        } else {
            // line 15
            echo "        <div class=\"alert warning\"> ";
            echo $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SCHEDULER_NOT_ENABLED", [0 => ($context["user"] ?? null)]);
            echo "</div>
    ";
        }
        // line 17
    ...
    <div class=\"alert notice\"><i class=\"fa fa-exclamation-circle\"></i> ";
        // line 18
        echo twig_escape_filter($this->env, $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SCHEDULER_WARNING", [0 => ($context["user"] ?? null)]), "html", null, true);
        echo "</div>
    ...
    <div id=\"cron-install\" class=\"form-border overlay ";
        ...
        <p>";
        // line 23
        echo $this->env->getExtension('Grav\Plugin\Admin\Twig\AdminTwigExtension')->tuFilter("PLUGIN_ADMIN.SCHEDULER_POST_INSTRUCTIONS", [0 => ($context["user"] ?? null)]);
        echo "</p>
    </div>
...
", "partials/tools-scheduler.html.twig", "/Users/krismawan_riki/Sites/grav-admin/user/plugins/admin/themes/grav/templates/partials/tools-scheduler.html.twig");
    }
}
